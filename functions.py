...
def convert_record_to_body(record_json: dict) -> dict:
    ...
    return {
        ...
        "value": [
            ...
            {"modelType": "Property", "idShort": "ProductionOrderNumber", "value": r["OperationNumber"],
             "valueType": "xs:int"},
            {"modelType": "Property", "idShort": "SetupTime", "value": r["SetupTime"], "valueType": "xs:float"},
            {"modelType": "Property", "idShort": "ProductionTime", "value": r["ProductionTime"],
             "valueType": "xs:float"},
            {"modelType": "Property", "idShort": "DelayTime", "value": r["DelayTime"], "valueType": "xs:float"},
            {"modelType": "Property", "idShort": "ProducedQuantity", "value": r["ProducedQuantity"],
             "valueType": "xs:float"},
            {"modelType": "Property", "idShort": "GoodQuantity", "value": r["GoodQuantity"], "valueType": "xs:float"},
            {
                ...
                "idShort": "Factors",
                "value": [
                    {"modelType": "Property", "idShort": "Factor1", "value": r["Factors"]["Factor1"],
                     "valueType": "xs:float"},
                    {"modelType": "Property", "idShort": "Factor2", "value": r["Factors"]["Factor2"],
                     "valueType": "xs:float"},
                    {"modelType": "Property", "idShort": "Factor3", "value": r["Factors"]["Factor3"],
                     "valueType": "xs:float"},
                    {"modelType": "Property", "idShort": "Factor4", "value": r["Factors"]["Factor4"],
                     "valueType": "xs:float"},
                ],
            },
        ],
